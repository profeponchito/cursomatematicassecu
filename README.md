...
21. ⏳ Página de verificación de folios (`verificar.html`) enlazada desde el QR.
22. ⏳ Trimestres 2 y 3 (ejes "Forma, espacio y medida" y "Análisis de datos y probabilidad") para los PDAs por grado.
23. ⏳ Desplegar el Web Endpoint real, configurar `WEBHOOK_URL` y subir a GitHub Pages.
24. ⏳ Pruebas en dispositivos móviles reales.
